  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-8 flex items-center justify-between border-b border-black/10 pb-4">
        ...
        <div className="flex gap-2 rounded-full border border-black/10 bg-black/50 p-1">
          <button
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {!isLong ? (
            <div className="space-y-4 text-base leading-relaxed text-neutral-600 sm:text-lg">
              <p>
            ...
            <div className="relative pl-6 border-l-2 border-black/10 space-y-12 text-base leading-relaxed text-neutral-600">
              
              {/* Chapter 1 */}
              <div className="relative group">
                <div className="absolute -left-[29px] top-1.5 h-3 w-3 rounded-full border border-light-bg bg-neutral-600 transition-all duration-300 group-hover:scale-125 group-hover:bg-black" />
                ...
                <div className="space-y-4">
                  ...
                  <p className="font-semibold text-black">But the system rejected me.</p>
              ...
              <div className="relative group">
                ...
                <div className="space-y-4">
                  ...
                  <p className="italic border-l-2 border-black/20 pl-4 text-neutral-300">But in the dark, I was building my mental models.</p>
              ...
              <div className="relative group">
                ...
                <div className="space-y-4">
                  <p>While everyone else was polishing resumes, I was studying leverage. <span className="font-semibold text-black italic">The Almanack of Naval Ravikant</span> changed the geometry of my brain. I had zero money, which meant I had zero room for delusion. It had to work.</p>
                  ...
                  <p>I consumed <span className="font-semibold text-black italic">Moneyball</span> and <span className="font-semibold text-black italic">The Big Short</span>. The lesson was obvious: the crowd is almost always wrong. The truth is hidden in plain sight, waiting for someone obsessed enough to exploit it.</p>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-black/5 border border-black/10 rounded-xl p-4 my-6">
                    <p className="text-xs font-bold text-black uppercase tracking-wider mb-2">The Law of Survival</p>
              ...
              <div className="relative group">
                ...
                <div className="space-y-4">
                  ...
                  <blockquote className="italic border-l-2 border-black/20 pl-4 py-1 text-neutral-600 my-6">
                  ...
                  <div className="pt-6 border-t border-black/10">
                    ...
                    <ul className="grid grid-cols-1 gap-2 sm:grid-cols-2 text-sm text-neutral-600 font-medium pl-0">
                      ...
                      <li className="flex items-center gap-2 sm:col-span-2"><span className="inline-block h-1.5 w-1.5 rounded-full bg-black" />Never stop compounding.</li>
                    </ul>
                  </div>

                  <p className="text-lg font-black tracking-tight text-black mt-6 pt-4 border-t border-black/10">
